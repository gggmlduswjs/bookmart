...
urlpatterns = [
    ...
    path('s/<str:slug>/order/<int:order_id>/edit/', views_simple.simple_order_edit, name='simple_order_edit'),
    ...
    path('orders/<int:pk>/return-inline/', views.return_create_inline, name='return_create_inline'),
    ...
    path('orders/api/quick-unship/', views.order_quick_unship, name='order_quick_unship'),
    path('orders/api/quick-undeliver/', views.order_quick_undeliver, name='order_quick_undeliver'),
    path('orders/api/bulk-tracking/', views.order_bulk_tracking, name='order_bulk_tracking'),
    path('orders/api/search/', views.order_search_api, name='order_search_api'),
    ...
    path('inbox/fetch/status/', views.fetch_emails_status, name='fetch_emails_status'),
    ...
    path('inbox/call/<int:pk>/form/', views.call_order_form_partial, name='call_order_form_partial'),
